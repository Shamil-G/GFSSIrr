...
export const solidaryPensionTabContext = {
    // Значения zone определяют id=""
    zones: {
        /*mainTableHelper: '#calc_pens_mainTableHelper',*/
        fragment: '#solidary_pension_mainBody',
    ...
    request: {
        fragment: {
            method: 'POST',
            url: ref_name => `/show-solidary-pension-fragment`
        },
    },
...
export default solidaryPensionTabContext;