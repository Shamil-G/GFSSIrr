...
report_name = 'Сведения о мероприятии «День открытых дверей»'
report_code = 'ОД_01'
...
def report_01(params, filename=f"rep_{report_code}.xlsx"):
	...
	with xlsxwriter.Workbook(output, {'in_memory': True}) as workbook:
		...
		##
		list_name_number = []
		list_name_date = ['Дата проведения']
		list_name_text = ["Область","Участники мероприятия (организация)", "Участие СМИ", "Место проведения", "Размещение в соц.сетях (ссылка)", "Исполнитель"]
		list_name_text_list = []
		list_name_text_center = ["Код области", "Номер протокола"]

		list_column_width =[11, 12, 14, 10, 40, 50, 40, 35, 35, 35]
